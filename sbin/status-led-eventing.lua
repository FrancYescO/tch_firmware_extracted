...
local function ledaction()
    if is_service_ok() == false then
        ...
        local packet = {}
        if infobutton_pressed == false and info_service_led_timeout > 0 then
            packet["state"] = "active"
            conn:send("statusled", packet)
        end
...
if services.voip ~= nil then
    ...
    events['mmpbx.voiceled.status'] = function(msg)
        if msg ~= nil then
            if ((msg.fxs_dev_0 == "true" and msg.fxs_dev_1 == "true") or ((msg.fxs_dev_0 == "" or msg.fxs_dev_0 == nil ) and msg.fxs_dev_1 == "true") or  (msg.fxs_dev_0 == "true" and (msg.fxs_dev_1 == "" or msg.fxs_dev_1 == nil )) or (msg.fxs_dev_0 == nil and msg.fxs_dev_1 == nil) or(msg.fxs_dev_0 == "" and msg.fxs_dev_1 == "")) then
