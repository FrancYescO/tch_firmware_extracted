...
iptables -t raw -N output_helper_binds
iptables -t raw -A OUTPUT -j output_helper_binds
ip6tables -t raw -N output_helper_binds
ip6tables -t raw -A OUTPUT -j output_helper_binds
