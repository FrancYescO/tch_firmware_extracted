...
proto_dhcp_setup() {
	...
	local ipaddr hostname clientid vendorid broadcast release reqopts defaultreqopts iface6rd sendopts delegate zone6rd zone mtu6rd customroutes arping initboot vendorinfolenfix noforcerenew classlessroute
	json_get_vars ipaddr hostname clientid vendorid broadcast release reqopts defaultreqopts iface6rd delegate zone6rd zone mtu6rd customroutes arping initboot vendorinfolenfix noforcerenew classlessroute
