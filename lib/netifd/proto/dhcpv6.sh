...
proto_dhcpv6_init_config() {
	...
	proto_config_add_boolean _3gpp_workarounds
}
...
proto_dhcpv6_setup() {
	...
	[ "$_3gpp_workarounds" = "1" ] && append opts "-3"
