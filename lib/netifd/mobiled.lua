...
for option, argument in helper.getopt(arg, 's:p:d:i:o') do
	if(option == "s") then
...
local event_data = { event = "session_activate", session_id = session_id, profile_id = profile_id, interface = interface, optional = optional }
