...
---
-- @module modules.command.newsrpuser_command
--
...
local cmd_name = "newsrpuser"
local usage_msg = [[
  Generate a SRP6a salt and verifier for the given username and password.
    -u  (string) the username
    -p  (string) the password
]]

local function newsrpuser_function(args)
...
-- Table representation of the newsrpuser command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = newsrpuser_function,
}
