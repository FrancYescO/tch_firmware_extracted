...
for i in $(seq 0 15); do
	...
	if [ "$?" -eq 0 ]; then
		...
		radio_chan_width=$(get_chan_width_from_radio $radio)
		...
		column3="$radio, $radio_state_str, $radio_channel, $radio_chan_width, $radio_cap"
