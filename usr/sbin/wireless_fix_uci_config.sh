...
if test -f "/lib/wireless/wireless_fix_uci_config_custo.sh"; then 
    echo "Executing custo fix UCI script" > /dev/console
    /lib/wireless/wireless_fix_uci_config_custo.sh
fi
