...
local DEPLOYSOFTWARENOW_UNICAST = "DEPLOYSOFTWARENOW_UNICAST"
local RTFD = "RTFD"
local GET_ACCESS_CONTROL_REQUEST = "GET_ACCESS_CONTROL_REQUEST"
local GET_ACCESS_CONTROL_RESPONSE = "GET_ACCESS_CONTROL_RESPONSE"
local SET_ACCESS_CONTROL_REQUEST = "SET_ACCESS_CONTROL_REQUEST"
...
local SET_WIFI_CONFIG_REQUEST_UNICAST = "SET_WIFI_CONFIG_REQUEST_UNICAST"
local WIFI_DR_ONBOARDING_REQUEST = "WIFI_DR_ONBOARDING_REQUEST"
...
local function load_encoder_functions(encoder)
  return {
    ...
    [DEPLOYSOFTWARENOW_UNICAST] = encoder.SEND_1905_DATA,
    [RTFD] = encoder.SEND_1905_DATA,
    [GET_ACCESS_CONTROL_REQUEST] = encoder.SEND_1905_DATA,
    [GET_ACCESS_CONTROL_RESPONSE] = encoder.SEND_1905_DATA,
    [SET_ACCESS_CONTROL_REQUEST] = encoder.SEND_1905_DATA,
    ...
    [SET_WIFI_CONFIG_REQUEST_UNICAST] = encoder.SEND_1905_DATA,
    [WIFI_DR_ONBOARDING_REQUEST] = encoder.SEND_1905_DATA,
  }
end
