...
local encodeEventToTags = {
  ...
  ["DEPLOYSOFTWARENOW_UNICAST"]       = {0x0A, 0x03},
  ["RTFD"]                            = {0x0A, 0x08},
  ["GET_ACCESS_CONTROL_REQUEST"]      = {0x0A, 0x09},
  ["GET_ACCESS_CONTROL_RESPONSE"]     = {0x0A, 0x0A},
  ["SET_ACCESS_CONTROL_REQUEST"]      = {0x0A, 0x0B},
  ["GET_LED_STATUS"]                  = {0x0A, 0x0C},
  ["SET_LED_STATUS"]                  = {0x0A, 0x0E},
  ["SET_WIFI_CONFIG_REQUEST"]         = {0x0A, 0x11},
  ["SET_WIFI_CONFIG_REQUEST_UNICAST"] = {0x0A, 0x11},
