...
local function prepareAgentResponse(mac, agentData, response)
  ...
  response[mac] = {
    ...
    ["WifiDrOnboardingStatus"] = agentData.wifiDrOnboardingStatus or "",
    ["LocalInterfaces"] = agentData.localInterfaces or {},
  }
...
local MAPControllerObject = {
  ['mapVendorExtensions.controller'] = {
    ...
    setMacAcl = {
      action_handler.setMacAcl, {["Radio"] = ubus.STRING, ["AclType"] = ubus.INT32, ["StaList"] = ubus.ARRAY}
    }
  }
}
