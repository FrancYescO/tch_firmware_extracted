...
local paramWithValidator = {
  ...
  ["uci.tod.ap."] = {
    state = "isBoolean",
    ssid = "validateTodSsidAP",
    ap = "validateTodSsidAP"
  },
  ["uci.tod.wifitod."] = {
    value = "isString"
  },
  ["uci.tod.action."] = {
    enabled = "isBoolean",
    object = "validateTodActObject",
    script = "validateTodActScript",
    value = "validateTodActTimer"
  },
  ["uci.tod.timer."] = {
    enabled = "isBoolean",
    name = "validateTimerName",
    stop_time = "validateWifitodTime",
    start_time = "validateWifitodTime",
  },
}
