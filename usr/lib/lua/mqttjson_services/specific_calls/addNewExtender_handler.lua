...
--- Gets RSSI value of the extender connected.
...
-- @function checkRSSIvalue
-- @param mac mac address of the extender
-- @param interfaceType type of interface used to connect
...
-- @function cmd
-- @param lookup table containing all the files required
-- @param inputMethod input type of the topic subscribed
...
-- @return table containing response messsage to the cloud
-- @error The requested payload for addNewExtender does not contains 'requestId'
function M.cmd(lookup, payload, inputMethod, connection, topic, handler)
  mqtt_lookup = lookup
  mqttHandler = handler
