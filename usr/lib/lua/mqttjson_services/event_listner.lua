...
-- Function to store connected device list
...
-- Function to fetch data from config, and listens the corresponding events
...
--- Event listener starts at the initialization of module(mqtt)
-- @function start
