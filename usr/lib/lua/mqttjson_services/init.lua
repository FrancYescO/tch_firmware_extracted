...
mqtt_lookup.x509 = require("tch.crypto.x509")
...
mqtt_lookup.response_handler = require('mqttjson_services.response_handler')
mqtt_lookup.request_handler = require('mqttjson_services.request_handler')
...
mqtt_lookup.mqtt_validators = require('mqttjson_services.mqttservices_validator')
mqtt_lookup.validator_mapper = require('mqttjson_services.mapValidators')
...
function mqttjson_service:init()
  ...
  if self.capath and self.certfile and self.keyfile and self.connectionurl and self.connectionport and self.tlsEnabled then
...
---Loads the MQTT module
-- @function loadModule
-- @error Failed to initialize mqttjson service
function M.loadModule()
  ...
  mqtt_lookup.mqttcommon.init(mqtt_lookup)
  mqtt_lookup.mqtt_validators.mqtt_lookup = mqtt_lookup
