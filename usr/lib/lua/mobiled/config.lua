...
function M.get_device_config(device)
	if not device.info.device_config_parameter or not device.info[device.info.device_config_parameter] or device.info[device.info.device_config_parameter] == "" then
