...
--               cb('hostman_voip_down')
    ...
    events['mmpbx.callstate'] = function(msg)
        if msg ~= nil and msg.profileType == "MMNETWORK_TYPE_SIP" and msg.profileUsable == true and (msg.device == "fxs_dev_0" or msg.device == "fxs_dev_1") then
            local newcall = true
    ...
    events['mmpbx.voiceled.status'] = function(msg)
        if msg ~= nil then
            ...
            -- One LED for both FXS
            if ((msg.fxs_dev_0 == "true" and msg.fxs_dev_1 == "true") or ((msg.fxs_dev_0 == "" or msg.fxs_dev_0 == nil ) and msg.fxs_dev_1 == "true") or  (msg.fxs_dev_0 == "true" and (msg.fxs_dev_1 == "" or msg.fxs_dev_1 == nil ))) then
