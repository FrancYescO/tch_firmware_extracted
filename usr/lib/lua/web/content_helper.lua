...
-- Method to return value of DM
-- @param #string path
-- @return #string DM value
function M.proxyGet(path, default)
  local dmValue = proxy.get(path)
  return dmValue and dmValue[1] and dmValue[1].value or default or ""
end
