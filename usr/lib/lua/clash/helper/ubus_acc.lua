...
allowed[ "mmdbd.callnumber.statistics"  ] = { "get" }
...
allowed[ "mmpbxbrcmfxs.state"           ] = { "get" }
...
allowed[ "fhcd"                         ] = { "dump", "config_changed", "set_loglevel", "get_topology" }
allowed[ "gpon.ploam"                   ] = { "state" }
allowed[ "gpon.ploam.auth"              ] = { "get", "set" }
allowed[ "gpon.trsv"                    ] = { "get_config", "get_txwavelen", "get_txrate", "get_info" }
allowed[ "gpon.trsv.threshold"          ] = { "get" }
allowed[ "gpon.wanconf"                 ] = { "get", "set" }
