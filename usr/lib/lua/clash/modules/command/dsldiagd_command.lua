...
---
-- @module modules.command.dsldiagd_command
--
...
local cmd_name = "dsldiagd"
local usage_msg = [[
  Start the DSL diagnostic daemon
]]

local function dsldiagd_function(args)
...
-- Table representation of the dsldiagd command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = dsldiagd_function,
}
