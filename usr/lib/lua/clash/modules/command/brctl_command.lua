...
---
-- @module modules.command.brctl_command
--
...
local cmd_name = "brctl"
local usage_msg = [[
  Ethernet bridge administration:
    --show retrieve list of bridges.
]]
local function brctl_function(args)
...
-- Table representation of the brctl command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = brctl_function,
}
