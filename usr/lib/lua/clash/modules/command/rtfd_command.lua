...
local usage_msg = [[
  Perform return-to-factory-defaults of gateway
    --soft  Perform 'soft' return-to-factory-defaults, preserving some settings.
            In order for a setting to be preserved, it must be explicitly
            configured to do so. By default, a custom setting is lost
            when performing a return-to-factory-defaults.
]]
