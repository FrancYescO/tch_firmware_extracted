...
---
-- @module modules.command.dmesg_command
--
...
local cmd_name = "dmesg"
local usage_msg = [[
  Print or control the kernel ring buffer
    -c   Clear ring buffer after printing
]]

local function dmesg_function(args)
...
-- Table representation of the dmesg command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = dmesg_function,
}
