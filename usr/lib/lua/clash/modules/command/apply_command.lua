...
local usage_msg = [[
  Apply previous changes done through the datamodel. Calling this command will perform the
  necessary start/stop/restart/reload/... actions on the daemons that were impacted by the datamodel changes.
]]
