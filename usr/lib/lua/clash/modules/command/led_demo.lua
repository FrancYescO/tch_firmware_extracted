...
---
-- @module modules.command.led_demo_command
--
...
local cmd_name = "led_demo"
local usage_msg = [[
  Will trigger the led demo
]]

local function led_demo_function(args)
...
-- Table representation of the led_demo command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = led_demo_function,
}
