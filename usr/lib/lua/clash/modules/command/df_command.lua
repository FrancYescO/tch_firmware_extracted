...
---
-- @module modules.command.df_command
--
...
local cmd_name = "df"
local usage_msg = [[
  This command provides filesystem usage statistics
    -h   Human readable
    -k   1024-byte blocks
    -m   1M-bytes blocks
    -T   Print filesystem type
    <file> (optional string) Filesystem
]]

local function df_function(args)
...
-- Table representation of the df command module
local command = {
  name = cmd_name,
  usage_msg = usage_msg,
  action = df_function,
