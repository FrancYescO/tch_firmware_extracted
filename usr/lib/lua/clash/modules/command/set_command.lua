...
local usage_msg = [[
  Change the value of a data model parameter.
    <path> (datamodel_path) The data model path to the parameter to be changed
    <value> (string) The new value for the data model parameter
]]
