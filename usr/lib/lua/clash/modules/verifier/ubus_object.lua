...
---
-- A module that contains the verification logic for an UBUS object name.
--
-- @module modules.verifier.ubus_object
...
local function raise_error()
  error("Invalid UBUS object name")
end

--- Verify if the given input looks like a valid UBUS object name.
-- A UBUS object name has to be a string.
--
...
local function verify(input)
  ...
  if type(input) ~= "string" then
    raise_error()
  -- UBUS object names start with a letter
