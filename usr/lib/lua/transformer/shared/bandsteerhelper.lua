...
local function setBandSteerPeerApAuthentication(baseap, needsetap)
  ...
  local passPhraseValue = getWirelessUciValue(baseap, "wpa_psk_key")
  setWirelessUciValue(passPhraseValue, needsetap, "wpa_psk_key", commitapply, transactions)
  if value == "wpa3-psk" or value == "wpa2-wpa3-psk" then
    setWirelessUciValue(passPhraseValue, needsetap.."_credential0", "passphrase", commitapply, transactions)
  end
end
