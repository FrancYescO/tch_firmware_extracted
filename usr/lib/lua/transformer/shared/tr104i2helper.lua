...
local tr104i2Objects = {
    ...
    {"Multi_Services_VoiceService_i_SIP_Network_i_EventSubscribe_i_"},
    ...
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_"},
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_Source_"},
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_Source_RTP_"},
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_Source_DSP_"},
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_Source_DSP_ReceiveCodec_"},
    {"Multi_Services_VoiceService_i_CallLog_i_Session_i_Source_DSP_TransmitCodec_"},
