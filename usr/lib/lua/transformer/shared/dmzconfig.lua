...
local config_maps = {
    network = {
        switch_vlan = {
            {{"vlan", "1", ".set"}, {ports = "1* 2* 3* 4* 8t"}, {ports = "1* 2* 3* 8t"}},
            {{"vlan", "2", ".add"}, nil, {device = "bcmsw_ext", vlan = "2", ports = "4* 8t"}},
        },
        vlan_eth3 = {
            {"vid", "1", "2"},
        },
        lan = {
           {"ifname", "vlan_eth0 vlan_eth1 vlan_eth2 vlan_eth3", "vlan_eth0 vlan_eth1 vlan_eth2"},
        },
        wan = {
