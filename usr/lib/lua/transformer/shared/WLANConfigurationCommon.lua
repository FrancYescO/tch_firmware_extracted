...
M.getMappings = function(commitapply)
    ...
    local setWLANDevice = {
        ...
        SSID = function(mapping, param, value, key)
            binding_wireless.sectionname = key
            binding_wireless.option = "ssid"
            local ssid = uci_helper.set_on_uci(binding_wireless, value, commitapply)
        end,
        ...
        BasicEncryptionModes = function(mapping, param, value, key)
		   ...
		   return nil, "wep is not supported"
                ...
                uci_helper.set_on_uci(binding_wireless, "wep", commitapply)
            elseif value == "None" then
                uci_helper.set_on_uci(binding_wireless, "none", commitapply)
            end
        end,
        ...
        WPAEncryptionModes = function(mapping, param, value, key)
            ...
            if wpaauthmode == "PSKAuthentication" then
                uci_helper.set_on_uci(binding_wireless, "wpa-wpa2-psk", commitapply)
            elseif wpaauthmode == "EAPAuthentication" then
                uci_helper.set_on_uci(binding_wireless, "wpa-wpa2", commitapply)
            end
        end,
        ...
        IEEE11iEncryptionModes = function(mapping, param, value, key)
            ...
            if wpa2authmode == "PSKAuthentication" then
                uci_helper.set_on_uci(binding_wireless, "wpa2-psk", commitapply)
            elseif wpa2authmode == "EAPAuthentication" then
                uci_helper.set_on_uci(binding_wireless, "wpa2", commitapply)
            end
        end,
