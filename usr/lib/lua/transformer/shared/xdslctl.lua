...
function createTableWithEmptyValues()
  ...
  addEmptyAdslMib( "CurrentProfileTI", 0)
  ...
  addEmptyAdslMib( "AllowedProfilesTI", " ")
...
local function getInfoValuesFromAdslMib( lineid )
  ...
  getallvalues["status"] = valueFromCmd(xdslctlinfo, "status", nil, nil)
  addAdslMibValue( adslMib, getallvalues, "mode", "Mode")
  addAdslMibValue( adslMib, getallvalues, "lrtr", "LastRetrainReason")
  addAdslMibValue( adslMib, getallvalues, "lips", "LastInitializationProcedureStatus")
  addAdslMibValue( adslMib, getallvalues, "maxrate", "DownstreamMaxBitRate", "UpstreamMaxBitRate")
  addAdslMibValue( adslMib, getallvalues, "currentrate", "DownstreamCurrRate", "UpstreamCurrRate")
  addAdditionalSubKey( getallvalues, "currentrate", "channel", 0 )
  addAdslMibValue( adslMib, getallvalues, "linkpowerstate", "PowerManagementState")
  addAdslMibValue( adslMib, getallvalues, "vdsl2profile", "CurrentProfile")
  addAdslMibValue( adslMib, getallvalues, "tpstc", "TpsTcBcm")
  addAdslMibValue( adslMib, getallvalues, "linestatus", "LineStatus")
  addAdslMibValue( adslMib, getallvalues, "trainingstatus", "TrainingStatus")
  addAdslMibValue( adslMib, getallvalues, "trellis", "TRELLISds", "TRELLISus")
  addAdslMibValue( adslMib, getallvalues, "snr", "DownstreamSNR", "UpstreamSNR", divideBy10)
  addAdslMibValue( adslMib, getallvalues, "attn", "DownstreamAttenuation", "UpstreamAttenuation", divideBy10)
  addAdslMibValue( adslMib, getallvalues, "pwr", "DownstreamPower", "UpstreamPower", divideBy10)
  addAdslMibValue( adslMib, getallvalues, "framing_msgc", "DownstreamFramingMSGc", "UpstreamFramingMSGc" )
  addAdslMibValue( adslMib, getallvalues, "framing_b", "DownstreamFramingB", "UpstreamFramingB")
  addAdslMibValue( adslMib, getallvalues, "framing_m", "DownstreamFramingM", "UpstreamFramingM")
  addAdslMibValue( adslMib, getallvalues, "framing_t", "DownstreamFramingT", "UpstreamFramingT")
  addAdslMibValue( adslMib, getallvalues, "framing_r", "DownstreamFramingR", "UpstreamFramingR")
  addAdslMibValue( adslMib, getallvalues, "framing_s", "DownstreamFramingS", "UpstreamFramingS")
  addAdslMibValue( adslMib, getallvalues, "framing_l", "DownstreamFramingL", "UpstreamFramingL")
  addAdslMibValue( adslMib, getallvalues, "framing_d", "DownstreamInterleaveDepth", "UpstreamInterleaveDepth")
  addAdslMibValue( adslMib, getallvalues, "framing_i", "DownstreamFramingI", "UpstreamFramingI")
  addAdslMibValue( adslMib, getallvalues, "framing_n", "DownstreamFramingN", "UpstreamFramingN")
  addAdslMibValue( adslMib, getallvalues, "framing_q", "DownstreamFramingQ", "UpstreamFramingQ")
  addAdslMibValue( adslMib, getallvalues, "framing_V", "DownstreamFramingV", "UpstreamFramingV")
  addAdslMibValue( adslMib, getallvalues, "counters_ohf", "OHFDs", "OHFUs")
  addAdslMibValue( adslMib, getallvalues, "counters_ohferr", "OHFErrDs", "OHFErrUs")
  addAdslMibValue( adslMib, getallvalues, "counters_sf", "SFDs", "SFUs")
  addAdslMibValue( adslMib, getallvalues, "counters_sferr", "SFErrDs", "SFErrUs")
  addAdslMibValue( adslMib, getallvalues, "counters_rs", "RSDs", "RSUs")
  addAdslMibValue( adslMib, getallvalues, "counters_rscorr", "RSCorrDs", "RSCorrUs")
  addAdslMibValue( adslMib, getallvalues, "counters_rsuncorr", "RSUnCorrDs", "RSUnCorrUs")
  addAdslMibValue( adslMib, getallvalues, "counters_hec", "ShowtimeXTURHECErrors", "ShowtimeXTUCHECErrors")
  addAdslMibValue( adslMib, getallvalues, "counters_ocd", "OCDDs", "OCDUs")
  addAdslMibValue( adslMib, getallvalues, "counters_lcd", "LCDDs", "LCDUs")
  addAdslMibValue( adslMib, getallvalues, "counters_totalcells", "BytesReceived", "BytesSent")
  addAdslMibValue( adslMib, getallvalues, "counters_datacells", "PacketsReceived", "PacketsSent")
  addAdslMibValue( adslMib, getallvalues, "counters_dropcells", "DiscardPacketsReceived", "DiscardPacketsSent")
  addAdslMibValue( adslMib, getallvalues, "counters_biterr", "ErrorsReceived", "ErrorsSent")
  addAdslMibValue( adslMib, getallvalues, "counters_es", "ShowtimeErroredSecsDs", "ShowtimeErroredSecsUs")
  addAdslMibValue( adslMib, getallvalues, "counters_ses", "ShowtimeSeverelyErroredSecsDs", "ShowtimeSeverelyErroredSecsUs")
  addAdslMibValue( adslMib, getallvalues, "counters_uas", "ShowtimeUnavailableSecsDs", "ShowtimeUnavailableSecsUs")
  addAdslMibValue( adslMib, getallvalues, "counters_as", "ShowtimeAvailableSecs")
  addAdslMibValue( adslMib, getallvalues, "counters_inp", "INPDs", "INPUs")
  addAdslMibValue( adslMib, getallvalues, "counters_inprein", "INPReinDs", "INPReinUs")
  addAdslMibValue( adslMib, getallvalues, "counters_delay", "DownstreamDelay", "UpstreamDelay")
  addAdslMibValue( adslMib, getallvalues, "counters_per", "PERDs", "PERUs") 
  addAdslMibValue( adslMib, getallvalues, "counters_or", "ORDs", "ORUs")
  addAdslMibValue( adslMib, getallvalues, "counters_agr", "AGRDs", "AGRUs")
  addAdslMibValue( adslMib, getallvalues, "counters_bitsw", "BitswapDs", "BitswapUs")
  addAdslMibValue( adslMib, getallvalues, "counters_noisemargin", "DownstreamNoiseMargin", "UpstreamNoiseMargin")

  addAdslMibValue( adslMib, getallvalues, "ginp_q", "Qds", "Qus")
  addAdslMibValue( adslMib, getallvalues, "ginp_v", "Vds", "Vus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rxqueue", "RxQueueds", "RxQueueus")
  addAdslMibValue( adslMib, getallvalues, "ginp_txqueue", "TxQueueds", "TxQueueus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rtxmode", "RTxModeds", "RTxModeus")
  addAdslMibValue( adslMib, getallvalues, "ginp_lookback", "LookBackds", "LookBackus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rrcbits", "RRCBitsds", "RRCBitsus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rtxtx", "RTxTxds", "RTxTxus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rtxc", "RTxCds", "RTxCus")
  addAdslMibValue( adslMib, getallvalues, "ginp_rtxuc", "RTxUCds", "RTxUCus")
  addAdslMibValue( adslMib, getallvalues, "ginp_leftrs", "LEFTRSds", "LEFTRSus")
  addAdslMibValue( adslMib, getallvalues, "ginp_mineftr", "MinEFTRds", "MinEFTRus")
  addAdslMibValue( adslMib, getallvalues, "ginp_errfreebits", "ErrFreeBitsds", "ErrFreeBitsus")
  addAdslMibValue( adslMib, getallvalues, "ginp_status", "GINPStatus")

  addAdslMibValue( adslMib, getallvalues, "vectoring_directionmode", "VectoringDirectionMode")
  addAdslMibValue( adslMib, getallvalues, "vectoring_rxbitswapmode", "VectoringRxBitSwapMode")
  addAdslMibValue( adslMib, getallvalues, "vectoring_disablevnmode", "VectoringDisableVNMode")
  addAdslMibValue( adslMib, getallvalues, "vectoring_vceaddress", "VectoringVceAddress")
  addAdslMibValue( adslMib, getallvalues, "vectoring_cntespktsend", "VectoringCntEsPktSend")
  addAdslMibValue( adslMib, getallvalues, "vectoring_cntespktdrop", "VectoringCntEsPktDrop")
  addAdslMibValue( adslMib, getallvalues, "vectoring_cntesstatsend", "VectoringCntEsStatSend")
  addAdslMibValue( adslMib, getallvalues, "vectoring_cntesstatdrop", "VectoringCntEsStatDrop")

  addAdslMibValue( adslMib, getallvalues, "firmware_version", "FirmwareVersion")

  addAdslMibValue( adslMib, getallvalues, "ACTINP", "ACTINP")
  addAdslMibValue( adslMib, getallvalues, "ACTSNRMODE", "ACTSNRMODEds", "ACTSNRMODEus")
  addAdslMibValue( adslMib, getallvalues, "ACTUALCE", "ACTUALCE")
  addAdslMibValue( adslMib, getallvalues, "ActualInterleavingDelay", "ActualInterleavingDelay")
  addAdslMibValue( adslMib, getallvalues, "AllowedProfiles", "AllowedProfiles")
  addAdslMibValue( adslMib, getallvalues, "AllowedProfilesTI", "AllowedProfilesTI")
  addAdslMibValue( adslMib, getallvalues, "CurrentProfileTI", "CurrentProfileTI")
  addAdslMibValue( adslMib, getallvalues, "HLOGG", "HLOGGds", "HLOGGus")
  addAdslMibValue( adslMib, getallvalues, "HLOGMT", "HLOGMTds", "HLOGMTus")
  addAdslMibValue( adslMib, getallvalues, "HLOGps", "HLOGpsds", "HLOGpsus")
  addAdslMibValue( adslMib, getallvalues, "INMCCds", "INMCCds")
  addAdslMibValue( adslMib, getallvalues, "INMIATOds", "INMIATOds")
  addAdslMibValue( adslMib, getallvalues, "INMIATSds", "INMIATSds")
  addAdslMibValue( adslMib, getallvalues, "INMINPEQMODEds", "INMINPEQMODEds")
  addAdslMibValue( adslMib, getallvalues, "INPREPORT", "INPREPORT")
  addAdslMibValue( adslMib, getallvalues, "INTLVBLOCK", "INTLVBLOCK")
  addAdslMibValue( adslMib, getallvalues, "INTLVDEPTH", "INTLVDEPTH")
  addAdslMibValue( adslMib, getallvalues, "LATN", "LATNds", "LATNus")
  addAdslMibValue( adslMib, getallvalues, "LIMITMASK", "LIMITMASK")
  addAdslMibValue( adslMib, getallvalues, "LPATH", "LPATH")
  addAdslMibValue( adslMib, getallvalues, "LSYMB", "LSYMB")
  addAdslMibValue( adslMib, getallvalues, "LastStateTransmitted", "LastStateTransmittedDownstream", "LastStateTransmittedUpstream")
  addAdslMibValue( adslMib, getallvalues, "LineEncoding", "LineEncoding")
  addAdslMibValue( adslMib, getallvalues, "LinkEncapsulationSupported", "LinkEncapsulationSupported")
  addAdslMibValue( adslMib, getallvalues, "LinkEncapsulationRequested", "LinkEncapsulationRequested")
  addAdslMibValue( adslMib, getallvalues, "LinkEncapsulationUsed", "LinkEncapsulationUsed")
  addAdslMibValue( adslMib, getallvalues, "LinkStatus", "LinkStatus")
  addAdslMibValue( adslMib, getallvalues, "MREFPSD", "MREFPSDds", "MREFPSDus")
  addAdslMibValue( adslMib, getallvalues, "NFEC", "NFEC")
  addAdslMibValue( adslMib, getallvalues, "RFEC", "RFEC")
  addAdslMibValue( adslMib, getallvalues, "QLNMT", "QLNMTds", "QLNMTus")
  addAdslMibValue( adslMib, getallvalues, "QLNps", "QLNpsds", "QLNpsus")
  addAdslMibValue( adslMib, getallvalues, "SATN", "SATNds", "SATNus")
  addAdslMibValue( adslMib, getallvalues, "SNRG", "SNRGds", "SNRGus")
  addAdslMibValue( adslMib, getallvalues, "SNRMT", "SNRMTds", "SNRMTus")
  addAdslMibValue( adslMib, getallvalues, "SNRMpb", "SNRMpbds", "SNRMpbus")
  addAdslMibValue( adslMib, getallvalues, "SNRps", "SNRpsds", "SNRpsus")
  addAdslMibValue( adslMib, getallvalues, "StandardUsed", "StandardUsed")
  addAdslMibValue( adslMib, getallvalues, "StandardsSupported", "StandardsSupported")
  addAdslMibValue( adslMib, getallvalues, "SuccessFailureCause", "SuccessFailureCause")
  addAdslMibValue( adslMib, getallvalues, "UPBOKLE", "UPBOKLE")
  addAdslMibValue( adslMib, getallvalues, "US0MASK", "US0MASK")
  addAdslMibValue( adslMib, getallvalues, "VirtualNoisePSD", "VirtualNoisePSDds", "VirtualNoisePSDus")
  addAdslMibValue( adslMib, getallvalues, "XTUCANSIRev", "XTUCANSIRev")
  addAdslMibValue( adslMib, getallvalues, "XTUCANSIStd", "XTUCANSIStd")
  addAdslMibValue( adslMib, getallvalues, "XTUCCountry", "XTUCCountry")
  addAdslMibValue( adslMib, getallvalues, "XTUCVendor", "XTUCVendor")
  addAdslMibValue( adslMib, getallvalues, "XTURANSIRev", "XTURANSIRev")
  addAdslMibValue( adslMib, getallvalues, "XTURANSIStd", "XTURANSIStd")
  addAdslMibValue( adslMib, getallvalues, "XTURCountry", "XTURCountry")
  addAdslMibValue( adslMib, getallvalues, "XTURVendor", "XTURVendor")

  addAdslMibValue( adslMib, getallvalues, "ACTATP", "ACTATPds", "ACTATPus")
  addAdslMibValue( adslMib, getallvalues, "ACTPSD", "ACTPSDds", "ACTPSDus")
  addAdslMibValue( adslMib, getallvalues, "BITSps", "BITSpsds", "BITSpsus")
  addAdslMibValue( adslMib, getallvalues, "HLINps", "HLINpsds", "HLINpsus")
  return getallvalues
end

--- Retrieves a sigle INFO value form the AdslMib.
-- @param keys   Parameter name to retrieve data from
-- @param subkey Parameter subkey. E.g. "ds" for Downstream value.
-- @param lineid Line number.
local function getInfoValueFromAdslMib( lineid, keys, subkey )
  local values = {}
  values = getInfoValuesFromAdslMib(lineid)
  if subkey ~= nil and subkey ~= "" then
    return values[keys][subkey]
  else
    return values[keys]
  end
end
