...
function M.checktimeslot(timer, obsolete_active_ts_nb, valid_activedaytime)
...
function starttimer(uciactionname, ucitimername, day, time, callbacktype, activedaytime, valid_activedaytime)
    local timertable
    local ulooptimer
    local timeout
    ...
    timertable = {utimer = ulooptimer, cbtype = callbacktype, tout = timeout, actionname = uciactionname, timername = ucitimername, active = isactive}
...
function createtimerofday(uciactionname, ucitimername, day, clocktime, callbacktype, activedaytime, timer, valid_activedaytime)
    local time, hep
    ...
    if clocktime == nil or clocktime == "" then
        ...
        if timer[day][time] ~= nil then
            ...
            timer[day][time] = starttimer(uciactionname, ucitimername, day, time, callbacktype, activedaytime, valid_activedaytime)
...
function M.start(uciactionname, ucitimer, activedaytime, valid_activedaytime)
    ...
    if ucitimer.start_time ~= nil and ucitimer.start_time ~= "" then
        ...
        for k, day in ipairs(startdays) do
            ...
            createtimerofday(uciactionname, ucitimer.name, day, startclock, "start", activedaytime, timer, valid_activedaytime)
        end
    end
    ...
    if ucitimer.stop_time ~= nil and ucitimer.stop_time ~= "" then
        ...
        for k, day in ipairs(stopdays) do
            createtimerofday(uciactionname, ucitimer.name, day, stopclock, "stop", activedaytime, timer, valid_activedaytime)
        end
    end
