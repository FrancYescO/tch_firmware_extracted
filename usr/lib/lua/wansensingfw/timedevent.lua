...
function M.init(event_name, timeout_sec, count)
   ...
   runtime.logger:info("TimedEvent("..self['asString']..") created")
   return self
end
...
function TimedEvent:timeout()
   ...
   runtime.logger:info("TimedEvent(" ..self['asString'].. ") fires"..to_do)
...
function TimedEvent:start()
   ...
   runtime.logger:info("TimedEvent(".. self['asString']..") starts")
   self['runFlag'] = true
...
function TimedEvent:stop()  -- request to stop, even before completing the requested iterations
   ...
   self['timer']=nil
   runtime.logger:info("TimedEvent(".. self['asString']..") stops")
   return true
end
