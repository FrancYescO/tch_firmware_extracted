...
function Device:start_command_with_source(command, timeout, data_source, interface_type)
	return do_start(self, start_command, { command, timeout, data_source }, interface_type)
end
...
function Device:start_singleline_command_with_source(command, response_prefix, timeout, data_source, interface_type)
	return do_start(self, start_singleline_command, { command, response_prefix, timeout, data_source }, interface_type)
end
...
function Device:start_multiline_command_with_source(command, response_prefix, timeout, data_source, interface_type)
	return do_start(self, start_multiline_command, { command, response_prefix, timeout, data_source }, interface_type)
end
