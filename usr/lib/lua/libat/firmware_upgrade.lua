...
function M.update_state(device, info)
	...
	if info.device_error then
		c:set("mobiled", "firmware_upgrade", "device_error", info.device_error)
	end
	if info.old_version then
		c:set("mobiled", "firmware_upgrade", "old_version", info.old_version)
	end
	c:save("mobiled")
...
function M.get_state()
	...
	info.device_error = c:get("mobiled", "firmware_upgrade", "device_error")
	info.old_version = c:get("mobiled", "firmware_upgrade", "old_version")
