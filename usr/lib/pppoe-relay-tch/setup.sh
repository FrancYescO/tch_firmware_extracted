...
add_relay_bridge() {
  ...
  ebt_broute -A BROUTING --logical-in ${bridge_l2dev} -j ppprelay_${bridge}
...
remove_relay_bridge() {
  ...
  ebt_broute -D BROUTING --logical-in ${bridge_l2dev} -j ppprelay_${bridge}
...
enable_relay_dev() {
  ...
  pppoerelay_log "enabling relay via ${dev} for bridge ${bridge}"
...
disable_relay_dev() {
  ...
  ebt_broute -D ppprelay_${bridge} -i ${dev} -j ppprelay
