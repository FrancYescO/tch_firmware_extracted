...
$(function(){
  ...
  $(document).on("click",".wan-edit", function(){
    ...
    if (editedFor == "WAN ADSL"){
      $('#wan-sel-conntype option[value="ipoa"]').css("display","" );
      $('#wan-sel-conntype option[value="pppoa"]').css("display","" );
    } else {
      $('#wan-sel-conntype option[value="ipoa"]').css("display","none" );
      $('#wan-sel-conntype option[value="pppoa"]').css("display","none" );
    }
    ...
    if (($("#wan-sel-conntype").val() == "pppoe")||($("#wan-sel-conntype").val() == "pppoa")){
    ...
    //$("#wan-sel-conntype").val() == "pppoe"||$("#wan-sel-conntype").val() == "pppoa" ?  $(".pppoe").css("display","" ) : $(".pppoe").css("display","none" );
    if ($("#wan-sel-addmode").val() == "dynamic"){
      $(".dynamic").css("display", "");
      $(".static").css("display","none" );
    }else {
  ...
  $("#global-apply").click(function(){
    ...
    postHandler("modals/wan.lp", params, true);
  });
