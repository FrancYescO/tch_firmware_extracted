$(function () {
  ...
  var target = "/modals/vf-wifi-network.lp";
  var params = [];
  ...
  var elements = {
    ...
    bandWidth : "#vf-wifi-txt-BWpercent",
    MaxBW : "#vf-wifi-txt-BWkbps",
  ...
  $("#global-cancel").click(function() {
     $("#content").load("/modals/vf-wifi-network.lp");
  });

  $("#vf-wifi-network-btn-apply").click(function() {
    postHandler(target, params);

    /*Giving a delay of 400ms to give enough time to render all data after redirecting to login page*/
