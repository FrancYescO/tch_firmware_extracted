  ...
  $("#btn-system-reboot").click(function() {
    ...
    confirmationDialogue(T["confirmmsg"], T["restartDev"], "Restart");
  ...
  $("#btn-system-reset").click(function() {
    ...
    confirmationDialogue(T["confirmmsg"],  T["factoryDefaults"], "Factory");
  ...
  $("#btn-system-softReset").click(function() {
    if (resetrtfdValue == "true") {
      return resetrtfd($("#resetting-msg"), $(this), "system_softReset");
    }
    confirmationDialogue(T["confirmmsg"], "Soft Reset", "SoftReset");
    $(document).on("click", ".SoftReset", function() {
      tch.removeProgress();
      tch.showProgress("Soft Resetting...");
      return resetReboot($("#resetting-msg"), $(this), "system_softReset");
    });
  });
