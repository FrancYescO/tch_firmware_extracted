$(function () {
  ...
  */
  ...
  $('<div class="table-row">\
    ...
    <div class="table-col ">\
        <input class="button button-delete deletebutton" id="tvSettings-btn-delete_'+ rows +'" type="button">\
  ...
  $(".tvSettings-table").on("click", ".button-add", function() {
    $("#addTVSettingsModal input[type=text]").val("")
  ...
  $("#global-cancel").click(function() {
    $("#content").load("/modals/tv-settings.lp");
  });
