  ...
  var elements = {
    ...
    startTime: "[role=dialog].in [id$=StartTime]",
    endTime: "[role=dialog].in [id$=EndTime]"
  }
  ...
  $(function() {
    ...
    $("#global-cancel").click(function() {
      $("#content").load("/modals/parental-control.lp");
    });
    ...
    $('#parental-tbl-mobile').on("click", ".button-delete", function() {
      ...
      $("#parental-tbl-desktop .button-delete").eq(thisIndex).trigger("click");
