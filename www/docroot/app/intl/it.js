        ...
        PAGES: {
            WIFI: {
                MAIN_NETWORK: {
                    ...
                    ACTIVATE_WPS_DESCRIPTION: 'E\' possibile accendere la funzionalità WPS (Wi-Fi Protected Setup) sia premendo direttamente il tasto sul tuo FASTGate, o direttamente attraverso il pulsante "Attiva WPS ora" presente anche in APP MyFastweb, oppure tramite il servizio vocale “My FASTGate” da Skill Amazon o Action Assistente Google, chiedendo “Alexa, chiedi a My FASTGate di accendere il WPS” oppure “Ok Google, chiedi a My FASTGate di accendere il WPS”. <br />'+
                    'Abilitando il pulsante software WPS, si accetta di rendere disponibile la possibilità di autenticazione ed associare dei dispositivi al Wi-Fi di casa mediante la pressione diretta del tasto presente sul modem FASTGate, l’abilitazione del pulsante (Attiva WPS ora) disponibile da App MyFastweb o l’attivazione del comando vocale da Servizio My FASTGate.',
