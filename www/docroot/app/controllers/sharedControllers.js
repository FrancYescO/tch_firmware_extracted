angular.module('fw')
    .controller('navCtrl', ['$translate', 'api','$scope','$rootScope', 'voiceService', 'ontService', '$timeout',  function($translate, api, $scope,$rootScope, voiceService, ontService, $timeout) {
        $scope.voice_available = false;
        $scope.ont_available = false;
   ...
   .controller('widgetParentalControlCtrl', ['$scope', '$uibModal', 'advancedService', 'devicesService', function($scope, $uibModal, advancedService, devicesService) {
        ...
        $scope.openAddDevices = function() {
            ...
            modalInstance.result.then(function(selectedItems) {
                ...
                advancedService.add_parental_devices(selectedItems).then(function(){
        ...
        $scope.openRemoveDevices = function() {
            ...
            modalInstance.result.then(function(selectedItems) {
                ...
                advancedService.remove_parental_devices(selectedItems).then(function(){
                    $scope.init_parental_status();
                    $scope.isDataReady = true;
                });
            });
