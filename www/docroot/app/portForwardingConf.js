angular.module('fw').constant('PortForwardingConf', {
    ...
    services: [
        ...
        {
            name: 'SSH on port 2222 in/out',
            code: '71',
            rules: [
                { port_start: 2222,   port_end: 2222,   proto: 'TCP' }
            ]
        },
        {
            name: 'Steam Games',
        ...
        {
            name: 'Telnet on port 2323 in/out',
            code: '73',
            rules: [
                { port_start: 2323,   port_end: 2323,   proto: 'TCP' }
            ]
        },
        {
            name: 'VNC',
