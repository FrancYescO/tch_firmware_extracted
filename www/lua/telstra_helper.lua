...
-- Below gatewayName's created to use dynamically in the files
local prodNumber = proxy.get("uci.env.var.prod_number")[1].value
M.prodName = "Telstra"
if prodNumber == "DGA0122TCH2" or prodNumber == "DWA0122BLN" then
  M.prodName = "Belong"
end
M.prodNameUpper = string.upper(M.prodName)
M.prodNameLower = string.lower(M.prodName)
