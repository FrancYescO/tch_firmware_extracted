...
return {
  ...
  Wireless = {
    wireless = {
      ...
      state5GEnable = {
        description = "To make 5G state enable",
	value = true
      },
      wpsValue = {
      ...
      handleQueryApply = {
        description = "Trigger apply() when handleQuery is called",
        value = false
      },
      multiapBroadCastACL = {
      ...
      showWEPMsg = {
        description = "To show warning message for selecting WEP Security Mode in GUI",
        value = true
      }
    },
    clientMonitor = {
