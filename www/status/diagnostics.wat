...
local led_status_paths = {
  background_enabled1 = "sys.class.leds.@ambient1_white.brightness",
  background_enabled2 = "sys.class.leds.@ambient2_white.brightness",
  background_enabled3 = "sys.class.leds.@ambient3_white.brightness",
  background_enabled4 = "sys.class.leds.@ambient4_white.brightness",
  background_enabled5 = "sys.class.leds.@ambient5_white.brightness",
  background_schedule = "uci.tod.action.@ledtod.enabled",
  background_timer = "uci.tod.action.@ledtod.timers.@1.value",
  line_red_path = "sys.class.leds.@broadband_red.brightness",
  line_green_path = "sys.class.leds.@broadband_green.brightness",
  wifi_red_path = "sys.class.leds.@wireless_red.brightness",
  wifi_green_path = "sys.class.leds.@wireless_green.brightness",
  wifi_orange_path = "sys.class.leds.@wireless_orange.brightness",
  wps_red_path = "sys.class.leds.@wps_red.brightness",
  wps_green_path = "sys.class.leds.@wps_green.brightness",
  wps_orange_path = "sys.class.leds.@wps_orange.brightness",
