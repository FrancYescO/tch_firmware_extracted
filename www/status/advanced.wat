...
local lan_map = {
  ...
  dhcpState = "uci.dhcp.dhcp.@lan.dhcpv4",
...
local function get_lan_status()
  ...
  data.DHCP_enabled = (lan_params.dhcpState == "server" or lan_params.dhcpState == "") and  "1" or "0"
...
service_lan_status.set = function(args)
  ...
  paths_dhcp[lan_map.dhcpState] = args.DHCP_enabled == "1" and "server" or "disabled"
...
local PMNameCodeMap = setmetatable({
  ...
  ['MSN Game Zone (DX)'] = '69',
  ['NNTP Server'] = '70',
  ['SSH on port 2222 in/out'] = '71',
  ['Steam Games'] = '72',
  ['Telnet on port 2323 in/out'] = '73',
  ['VNC'] = '74',
