      ...
      if(dataset.forceTooltips){
        chart.getDatasetMeta(i).data.forEach(function (sector, j) {
          if(dataset.forceTooltips === true //if it's true, do for all
            ...
            || (dataset.forceTooltips === "first" && j === 0) //if it's "last", and the index is the first
            || (dataset.forceTooltips === "last" && j === dataset.data.length) //if it's "last", and the index is the last
      ...
      if(dataset.__metaDoMinMaxPoints){
        ...
        var doMinMaxArray = function(key){
          ...
          if(typeof customVal !== "undefined" && customVal !== null){
            ...
            arr.fill(dataset.__metaDoMinMaxPoints[initPrefix + key]);
