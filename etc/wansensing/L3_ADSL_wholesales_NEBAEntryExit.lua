...
local CurrentScenarioName="ADSL_wholesales_NEBA" -- should match with ./lib/scenario.lua
...
function M.entry(runtime, l2type)
   ...
   if InterfaceMAP[CurrentScenarioName] then
    ...
    --Enable QoS for ATM device atm_0_35
        x:set("qos", "atm_0_35", "enable", "1")
        x:commit("qos")
