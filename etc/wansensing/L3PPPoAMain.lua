...
--   logger:notice("The L3PPPoA main script is checking link connectivity and DHCP on l2type interface " .. tostring(l2type))
...
--      return "L3PPPoA" -- if we get there, then we're not concerned, the non used L2 went down
   end
end
