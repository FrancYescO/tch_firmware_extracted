...
function M.entry(runtime, l2type)
	...
	os.execute("fapctl tm --queueprofile --queueprofileid 1 --dropprob 100 --minthreshold 32 --maxthreshold 64")
	os.execute("fapctl tm --xtmchanneldropalg --channel 0 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 1 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 2 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 3 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 4 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 5 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 6 --red --queueprofileid 1;fapctl tm --xtmchanneldropalg --channel 7 --red --queueprofileid 1")
