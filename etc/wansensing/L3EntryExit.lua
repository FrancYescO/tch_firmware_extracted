...
function M.entry(runtime, l2type)
	...
	x:set("network", "wan", "auto", "0")
        ...
        os.execute("bcmvopiconfig unload")
        os.execute("bcmvopiconfig load")
        os.execute("vlanctl --rule-remove-all atm_8_35_v0")
        os.execute("vlanctl --rule-remove-all atm_8_81_v0")
        os.execute("vlanctl --tx --tags 0 --if atm_8_35 --filter-dscp 46 --filter-txif atm_8_35_v0 --push-tag --set-vid 0 0 --dscp2pbits 0 --rule-append")
        os.execute("vlanctl --tx --tags 0 --if atm_8_81 --filter-dscp 46 --filter-txif atm_8_81_v0 --push-tag --set-vid 0 0 --dscp2pbits 0 --rule-append")
