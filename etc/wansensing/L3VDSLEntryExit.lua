...
--   logger:notice("L3VDSLEntry: configuring PPPoEoVDSL on wan interface on l2type interface " .. tostring(l2type))
   ...
   logger:notice("wan interface UP")
...
--    logger:notice("The L3VDSL exit script is using transition " .. transition .. " using l2type " .. tostring(l2type))
