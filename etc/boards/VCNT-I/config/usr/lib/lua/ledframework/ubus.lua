...
--               cb('hostman_voip_down')
    ...
    events['mmpbx.voiceled.status'] = function(msg)
        if msg ~= nil then
            ...
            elseif  msg.fxs_dev_0 == "disabled" then
                cb('profile_line1_disabled')
            else
                cb('profile_line1_usable_false')
            end
            if msg.fxs_dev_1 == "true" then
                cb('profile_line2_usable_true')
            elseif  msg.fxs_dev_1 == "disabled" then
                cb('profile_line2_disabled')
            else
                cb('profile_line2_usable_false')
            end

            if(msg.fxs_dev_0 == "true" and msg.fxs_dev_1 == nil) or ((msg.fxs_dev_0 == nil and msg.fxs_dev_1 == "true") ) then
                cb('fxs_profiles_usable_true')
            elseif ((msg.fxs_dev_0 == "true" and msg.fxs_dev_1 == "true") or (msg.fxs_dev_0 == "" and msg.fxs_dev_1 == "true") or (msg.fxs_dev_0 == "true" and msg.fxs_dev_1 == "")) then
                cb('fxs_profiles_usable_true')
            else
    ...
    events['mobiled.leds'] = function(msg)
        if type(msg) == "table" and msg.bars ~= nil then
