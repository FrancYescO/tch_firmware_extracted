...
# Filter: 802_1ag_cfm
bs /b/c filter entry[{filter=etype_802_1ag_cfm,ports=lan0}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=etype_802_1ag_cfm,ports=lan1}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=etype_802_1ag_cfm,ports=lan2}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=etype_802_1ag_cfm,ports=lan3}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=etype_802_1ag_cfm,ports=lan4}]={enabled=yes,action=host}

# Filter: DHCP 
bs /b/c filter entry[{filter=dhcp,ports=lan0}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=dhcp,ports=lan1}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=dhcp,ports=lan2}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=dhcp,ports=lan3}]={enabled=yes,action=host}
bs /b/c filter entry[{filter=dhcp,ports=lan4}]={enabled=yes,action=host}
