...
stateMachines = {
    ambient = {
        ...
        actions = {
            ambient_loop = {
                patternLed("ambient1:white", "80000000", 500),
                patternLed("ambient2:white", "08000008", 500),
                patternLed("ambient3:white", "00800080", 500),
                patternLed("ambient4:white", "00080800", 500),
                patternLed("ambient5:white", "00008000", 500),
            },
            ambient_on = {
