    ...
    power = {
        ...
        transitions = {
            power_started = {
                ...
                network_interface_wan_ifup = "internet_connected_ipv4",
                network_interface_wan6_ifup = "internet_connected_ipv6",
            },
            internet_connected_ipv4 = {
                fwupgrade_state_upgrading = "upgrade",
            ...
            internet_connected_ipv6 = {
                fwupgrade_state_upgrading = "upgrade",
                network_interface_wan6_ifdown = "power_started",
                network_interface_broadband_ifdown = "power_started",
            ...
            internet_connected_ipv4_and_v6 = {
                fwupgrade_state_upgrading = "upgrade",
                network_interface_broadband_ifdown = "power_started",
                network_interface_wan_ifdown = "internet_connected_ipv6",
                network_interface_wan6_ifdown = "internet_connected_ipv4",
            },
            upgrade = {
    ...
    internet = {
        ...
        transitions = {
            ...
            internet_connecting = {
                ...
                network_interface_wan_ifup = "internet_connected_ipv4",
                network_interface_wan6_ifup = "internet_connected_ipv6",
                network_neigh_wan_ifup = "internet_connected_ipv4",
                network_neigh_wan6_ifup = "internet_connected_ipv6",
            ...
            internet_connected_ipv4 = {
                xdsl_0 = "internet_disconnected",
                xdsl_1 = "internet_connected_ipv4_ddbdd",
                xdsl_2 = "internet_connected_ipv4_ddbdd",
            ...
            internet_connected_ipv6 = {
                xdsl_0 = "internet_disconnected",
                xdsl_1 = "internet_connected_ipv6_ddbdd",
                xdsl_2 = "internet_connected_ipv6_ddbdd",
            ...
            internet_connected_ipv4_and_v6 = {
                ...
                network_interface_wan6_ifdown = "internet_connected_ipv4",
                network_interface_broadband_ifdown = "internet_disconnected",
                network_interface_wan_no_ip = "internet_connected_ipv6",
                network_interface_wan6_no_ip = "internet_connected_ipv4"
            },
...
-- 'ddbdd' stands for 'Don't Disconnect By DSL Down'
            internet_connected_ipv4_ddbdd = {
                xdsl_0 = "internet_connected_ipv4",
            ...
            internet_connected_v6_ddbdd = {
                xdsl_0 = "internet_connected_ipv6",
                network_device_eth4_down = "internet_disconnected",
                network_interface_wan6_ifdown = "internet_connecting",
                network_interface_broadband_ifdown = "internet_disconnected",
            ...
            internet_connected_ipv4_and_v6_ddbdd = {
                ...
                network_device_eth4_down = "internet_disconnected",
                network_interface_wan_ifdown = "internet_connected_ipv6_ddbdd",
                network_interface_wan6_ifdown = "internet_connected_ipv4_ddbdd",
                network_interface_broadband_ifdown = "internet_disconnected",
                network_interface_wan_no_ip = "internet_connected_ipv6_ddbdd",
                network_interface_wan6_no_ip = "internet_connected_ipv4_ddbdd"
            },
        },
        actions = {
            internet_disconnected = {
            ...
            internet_connecting = {
                staticLed("internet:green", false),
-- Telstra specification, Red Solid on: Internet connection setup fail
                  staticLed("internet:red", true)
           },
            internet_connected_ipv4 = {
                netdevLedOWRT("internet:green", 'wan', 'link'),
                staticLed("internet:red", false)
            },
            internet_connected_ipv6 = {
                netdevLedOWRT("internet:green", 'wan6', 'link'),
                staticLed("internet:red", false)
            },
            internet_connected_ipv4_and_v6 = {
                netdevLedOWRT("internet:green", 'wan', 'link'),
        ...
        patterns_depend_on = {
            ...
            internet_connected_ipv4 = {"status"},
            internet_connected_ipv6 = {"status"},
            internet_connected_ipv4_and_v6 = {"status"},
            internet_connected_ipv4_ddbdd = {"status"},
            internet_connected_ipv6_ddbdd = {"status"},
    ...
    ethernet = {
        ...
        actions = {
            ethernet = {
                netdevLed("ethernet:green", 'eth0 eth1 eth2 eth3', 'link')
            }
        },
        patterns_depend_on = {
            ethernet = {
