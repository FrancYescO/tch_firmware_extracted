        ...
        voice = {
          initial = "off",
                ...
                fxs_profiles_usable = {
                    ...
                    callstate_MMPBX_CALLSTATE_DIALING_fxs_dev_0 = "fxs_profiles_solid",
                    callstate_MMPBX_CALLSTATE_DIALING_fxs_dev_1 = "fxs_profiles_solid",
                    callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_0 = "fxs_profile1_flash",
                    callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_1 = "fxs_profile2_flash"
                },
                fxs_profiles_solid = {
					   callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_0 = "fxs_profile1_flash",
					   callstate_MMPBX_CALLSTATE_CALL_DELIVERED_fxs_dev_0 = "fxs_profile1_flash",
                       callstate_MMPBX_CALLSTATE_CONNECTED_fxs_dev_0  = "fxs_profile1_flash",
					   callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_1 = "fxs_profile2_flash",
					   callstate_MMPBX_CALLSTATE_CALL_DELIVERED_fxs_dev_1 = "fxs_profile2_flash",
                       callstate_MMPBX_CALLSTATE_CONNECTED_fxs_dev_1  = "fxs_profile2_flash",
                       callstate_MMPBX_CALLSTATE_IDLE_fxs_dev_0 = "fxs_profiles_usable",
                       callstate_MMPBX_CALLSTATE_IDLE_fxs_dev_1 = "fxs_profiles_usable"
               },
                fxs_profile1_flash = {
					   callstate_MMPBX_CALLSTATE_DISCONNECTED_fxs_dev_0 = "fxs_profiles_solid",
					   callstate_MMPBX_CALLSTATE_IDLE_fxs_dev_0 = "fxs_profiles_usable",
					   callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_1 = "fxs_profiles_flash",
					   callstate_MMPBX_CALLSTATE_CALL_DELIVERED_fxs_dev_1 = "fxs_profiles_flash",
                       callstate_MMPBX_CALLSTATE_CONNECTED_fxs_dev_1  = "fxs_profiles_flash"
               },
               fxs_profile2_flash = {
					   callstate_MMPBX_CALLSTATE_DISCONNECTED_fxs_dev_1 = "fxs_profiles_solid",
					   callstate_MMPBX_CALLSTATE_IDLE_fxs_dev_1 = "fxs_profiles_usable",
					   callstate_MMPBX_CALLSTATE_ALERTING_fxs_dev_0 = "fxs_profiles_flash", 
                       callstate_MMPBX_CALLSTATE_CALL_DELIVERED_fxs_dev_0 = "fxs_profiles_flash",
                       callstate_MMPBX_CALLSTATE_CONNECTED_fxs_dev_0  = "fxs_profiles_flash",
               },
               fxs_profiles_flash = {
						callstate_MMPBX_CALLSTATE_DISCONNECTED_fxs_dev_0 = "fxs_profile2_flash",
                        callstate_MMPBX_CALLSTATE_DISCONNECTED_fxs_dev_1 = "fxs_profile1_flash"
               },
                off = {
