...
--                network_interface_wan6_ifdown = "internet_disconnected",
            ...
            internet_connected_ipv4_and_v6 = {
                ...
                network_interface_wan_ifdown = "internet_ipv4_or_v6",
                network_interface_wan6_ifdown = "internet_ipv4_or_v6",
                network_interface_broadband_ifdown = "internet_disconnected",
                network_interface_wan_no_ip = "internet_ipv4_or_v6",
                network_interface_wan6_no_ip = "internet_ipv4_or_v6"
            },
...
-- 'ddbdd' stands for 'Don't Disconnect By DSL Down'
            ...
            internet_connected_ipv4_and_v6_ddbdd = {
                ...
                network_interface_wan_ifdown = "internet_ipv4_or_v6_ddbdd",
                network_interface_wan6_ifdown = "internet_ipv4_or_v6_ddbdd",
                network_interface_broadband_ifdown = "internet_disconnected",
                network_interface_wan_no_ip = "internet_ipv4_or_v6_ddbdd",
                network_interface_wan6_no_ip = "internet_ipv4_or_v6_ddbdd"
            }
        },
        actions = {
            internet_disconnected = {
