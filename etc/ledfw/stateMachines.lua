...
local is_onboarding_enabled = is_onboarding_enabled
...
local onboarding_enabled = is_onboarding_enabled()

local function WPSSuccessState()
--   return (onboarding_enabled and "onboarding_discovery") or "success"
   return (is_onboarding_enabled() and "onboarding_discovery") or "success"
end

local function WFDPeerDetectedState()
--   return (onboarding_enabled and "onboarding") or nil
   return (is_onboarding_enabled() and "onboarding") or nil
end
...
local function CheckConditionsWiFi()
   ...
   elseif (not WiFi_2p4G_on or WiFi_2p4G_sec == 'wpa') and (not WiFi_5G_on or WiFi_5G_sec == 'wpa') then
      WiFiNetDevLedRed = false
      WiFiNetDevLedOrange = false
      WiFiNetDevLedGreen = true
   elseif WiFi_2p4G_sec == 'no' or WiFi_5G_sec == 'no' then
...
stateMachines = {
    power = {
        ...
        actions = {
            power_started = {
                staticLed("broadband:orange", true),
            }
        },
    },
    broadband = {
        ...
        transitions = {
            idling = {
                ...
                network_device_eth4_up = "ethwan",
            },
            ethwan = {
                network_device_eth4_down = "idling",
            },
            training = {
                xdsl_0 = "idling",
                xdsl_2 = "synchronizing",
        ...
        actions = {
-- ethwan eth4 connected event needed to distinguish between DSL and ETHWAN;
            idling = {
...
-- 'ddbdd' stands for 'Don't Disconnect By DSL Down'
        ...
        patterns_depend_on = {
            internet_connected_ipv4_or_v6 = { "remote_mgmt" },
            internet_connected_ipv4_and_v6 = { "remote_mgmt" },
            internet_connected_ipv4_or_v6_ddbdd = { "remote_mgmt" },
            internet_connected_ipv4_and_v6_ddbdd = { "remote_mgmt" },
            internet_connected_mobiledongle = { "remote_mgmt" },
        }
    },
    wifi = {
    ...
    wps = {
        ...
        transitions = {
            ...
            inprogress = {
                ...
                wifi_wps_off = "off",
                wifi_wps_idle = "idle",
                wfd_onboarding_inprogress = WFDPeerDetectedState,
                wifi_wps_success = WPSSuccessState
            },
            success = {
                wifi_wps_idle = "idle",
                wifi_wps_off = "off",
            ...
            onboarding_discovery = {
                wfd_onboarding_inprogress = "onboarding",
                wfd_no_peer = "success"
            },
            onboarding = {
                wfd_onboarding_success = "onboarding_success",
                wfd_onboarding_error = "onboarding_error",
            },
            onboarding_success = {
                wfd_onboarding_idle = "idle",
                wifi_wps_inprogress = "inprogress",
            },
            setup_locked = {
                wifi_wps_off = "off",
